                ...
                <div class="row" id="product-list">
                    ...
                    if ($sonuc && mysqli_num_rows($sonuc) > 0) {
                        while ($urun = mysqli_fetch_assoc($sonuc)) {
                            // Yeni eklenen ürün için highlight sınıfı ekle
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="product-card <?= $highlight_class ?>">
                                    <img src="<?= !empty($urun['resim_url']) ? htmlspecialchars($urun['resim_url']) : 'images/default-necklace.jpg' ?>" 
                                         class="product-image" 
